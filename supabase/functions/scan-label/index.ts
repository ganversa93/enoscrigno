...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const promptText = images.length > 1
      ? 'Analizza queste due foto della stessa bottiglia di vino (fronte etichetta e controetichetta) ed estrai tutte le informazioni visibili, combinando i dati da entrambe le immagini — la controetichetta spesso contiene dettagli aggiuntivi come importatore, gradazione esatta, annata o denominazione estesa non presenti sul fronte. Rispondi SOLO con JSON valido, zero testo extra, zero markdown. Schema: {"name":"","producer":"","vintage":null,"type":"Rosso|Bianco|Rosato|Spumante|Dolce|Passito|Altro","doc":"","grapes":"","region":"","province":"","country":"","abv":null,"drink":"","notes":""}. Campi non visibili in nessuna delle due foto: stringa vuota o null.'
      : 'Analizza questa etichetta di vino ed estrai tutte le informazioni visibili. Rispondi SOLO con JSON valido, zero testo extra, zero markdown. Schema: {"name":"","producer":"","vintage":null,"type":"Rosso|Bianco|Rosato|Spumante|Dolce|Passito|Altro","doc":"","grapes":"","region":"","province":"","country":"","abv":null,"drink":"","notes":""}. Campi non visibili: stringa vuota o null.';
